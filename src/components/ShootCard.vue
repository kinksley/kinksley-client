...
<div>
    <b-row class="mb-2">
        <b-col sm="6">
        <img class="img-fluid" :src="'https://cdnp.kink.com/assets/channels/logo-300x100/home-logo-' + this.siteImgPart + '.png'" alt="">
        </b-col>
    </b-row>
    <b-row>
        <b-col>
    ...
    <b-row class="mb-2">
        ...
        <p v-if="shoot.models.length > 0" class="mb-0">
...
export default {
  ...
  methods: {
    parseSiteName () {
      if (this.shoot.siteName === 'harmonyfetish') {
        this.siteImgPart = 'harmony-fetish'
      } else if (this.shoot.siteName === 'publicdisgrace') {
        this.siteImgPart = 'publicdiscrace'
      } else {
        this.siteImgPart = this.shoot.siteName
      }
    }
  }
}
